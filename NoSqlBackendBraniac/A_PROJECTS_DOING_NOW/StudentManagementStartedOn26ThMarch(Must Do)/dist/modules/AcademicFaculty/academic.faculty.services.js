...
exports.AcademicSemesterFacultyServices = void 0;
...
const updateAcademicFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academic_faculty_model_1.AcademicFaculty.findOneAndUpdate({ _id: id }, payload, {
        new: true
    });
    return result;
});
exports.AcademicSemesterFacultyServices = {
